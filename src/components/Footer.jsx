...
const Footer = () => {
  return (
    <div className='max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-black'>
      <div>
        <h1 className='w-full text-3xl font-bold text-black'>UJJWAL SINHA -(TE AMO).</h1>
      ...
      <div className='text-center text-black max-w-[1240px] mx-auto'>  @Made by Ujjwal sinha 
     <p className='text-center max-w-[1240px] mx-auto'> mummy kasam copy mt krna </p> </div>
    </div>
  );
};
